...
/// Run with: dart run tool/add_sample_products.dart
Future<void> main() async {
  ...
  await _addCategories(dio, baseUrl);

  // Add products
  await _addProducts(dio, baseUrl);

  print('✅ Sample data added successfully!');
}

Future<void> _addCategories(Dio dio, String baseUrl) async {
  final categories = [
    {
      'name': 'Electronics',
...
Future<void> _addProducts(Dio dio, String baseUrl) async {
  final products = [
    {
      'name': 'iPhone 15 Pro',
      'description':
