...
class _$CategoryModelImpl extends _CategoryModel {
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, name: $name, description: $description, imageUrl: $imageUrl, productCount: $productCount)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, description, imageUrl, productCount);
